    ...
    <div class="fish-grid">
      <?php if($result->num_rows > 0): ?>
        <?php while($row = $result->fetch_assoc()): ?>
          <?php $stock = (int)$row['stock']; $out = $stock <= 0; ?>
          <div class="fish-card<?php echo $out ? ' out-of-stock' : ''; ?>" data-id="<?php echo (int)$row['id']; ?>" data-price="<?php echo $row['price']; ?>" data-stock="<?php echo $stock; ?>" data-stock-status="<?php echo $out ? 'out-of-stock' : 'in-stock'; ?>">
