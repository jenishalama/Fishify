  ...
  <section class="aquarium-filters-section">
    <div class="container">
      ...
      <div class="aquarium-filters-grid">
        ...
        <div class="aquarium-filter-group filter-actions">
      ...
      <div class="aquarium-grid">
        <?php if ($result->num_rows > 0): ?>
          <?php while ($row = $result->fetch_assoc()): ?>
            ...
            <div class="aquarium-card<?php echo $out ? ' out-of-stock' : ''; ?>" data-id="<?php echo (int) $row['id']; ?>"
              data-price="<?php echo $row['price']; ?>" data-stock="<?php echo $stock; ?>"
              ...
              <div class="aquarium-info">
                <h3><a href="product.php?id=<?php echo (int) $row['id']; ?>"
                    class="aquarium-title-link"><?php echo htmlspecialchars($row['name']); ?></a></h3>
        ...
        <?php endif; ?>
           <div class="no-results" id="noResults" style="display: none;">
                <p>No aquariums match your filters. Try adjusting your criteria.</p>
            </div>
      </div>
