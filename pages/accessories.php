      ...
      <div class="fish-grid">
        <?php if ($result->num_rows > 0): ?>
          <?php while ($row = $result->fetch_assoc()): ?>
            ...
            <div class="fish-card<?php echo $out ? ' out-of-stock' : ''; ?>" data-id="<?php echo (int) $row['id']; ?>"
              data-price="<?php echo $row['price']; ?>" data-stock="<?php echo $stock_num; ?>"
       ...
       <div class="no-results" id="noResults" style="display: none;">
                <p>No accessories match your filters. Try adjusting your criteria.</p>
            </div>
      </div>
